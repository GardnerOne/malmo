...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        this.drawHoveringText(Arrays.<String>asList(new String[] {text}), x, y);
    }
        ...
        if (component != null && component.getStyle().getHoverEvent() != null)
        {
            ...
            else if (hoverevent.getAction() == HoverEvent.Action.SHOW_ACHIEVEMENT)
            {
                ...
                if (statbase != null)
                {
                    ...
                    if (s1 != null)
                    {
                        list.addAll(this.fontRenderer.listFormattedStringToWidth(s1, 150));
                    }
                ...
                {
                    this.drawHoveringText(TextFormatting.RED + "Invalid statistic/achievement!", x, y);
                }
            }
