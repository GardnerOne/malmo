...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    /**
     * Copy data from the given old player into this one, called when respawning after death or returning from the End
     *  
     * @param respawnFromEnd If true, the player did not die, and thus their inventory, xp, etc. should be preserved
     */
    public void clonePlayer(EntityPlayer oldPlayer, boolean respawnFromEnd)
    {
        ...
        this.enderChest = oldPlayer.enderChest;
